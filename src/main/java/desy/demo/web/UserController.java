...
import desy.demo.model.binding.UserLoginBindingModel;
import desy.demo.model.binding.UserRegisterBindingModel;
...
public class UserController {
    ...
    public String loginConfirm(@Valid @ModelAttribute UserLoginBindingModel userLoginBindingModel,
        ...
        UserServiceModel user=userService.findUserByEmailAndPassword(userLoginBindingModel.getEmail(),
